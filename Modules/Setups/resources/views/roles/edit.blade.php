        ...
        <div class="col-12">
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    <form id="role-form" method="post" autocomplete="off" action="{{ route("setups.roles.update", $role->id) }}">
                        <div class="row">
                            <div class="col-6">
                                @csrf
                                <div class="form-group mb-4">
                                    ...
                                    <input value="{{ old("txtPermission", $role->name) }}" id="t-Permission" type="text" name="txtPermission" placeholder="{{ __("label.form.actions.permission") }}" class="form-control" required autofocus tabindex="1"  />
                                    @error('txtPermission')
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input value="{{ old("txtPermission", $role->name_kh) }}" id="t-PermissionKh" type="text" name="txtPermissionKh" placeholder="{{ __("label.form.actions.permission.kh") }}" class="form-control" required tabindex="2">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <textarea id="t-Description" type="text" name="txtDescription" placeholder="{{ __("label.form.actions.description") }}" class="form-control" tabindex="3">{{ old("txtPermission", $role->description) }}</textarea>
                                </div>
