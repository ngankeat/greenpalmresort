                        ...
                        <div class="col-12 col-xxl-4 col-xl-6 col-lg-8 col-md-8 col-sm-9">
                            <form>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input disabled value="{{ old("txtModuleIcon", $row->icon) }}" id="t-ModuleIcon" type="text" name="txtModuleIcon" placeholder="{{ __("label.form.modules.icon") }}" class="form-control" tabindex="5">
                                </div>
                                <div class="form-group mb-4">
                                    <p>{{ __("label.form.modules.order") }} <code>*</code></p>
                                    <label for="t-ModuleOrder" class="visually-hidden">{{ __("label.form.modules.order") }}</label>
                                    <input disabled value="{{ old("txtModuleOrder", $row->order) }}" id="t-ModuleOrder" type="text" name="txtModuleOrder" placeholder="{{ __("label.form.modules.order") }}" class="form-control" required tabindex="6">
                                </div>
