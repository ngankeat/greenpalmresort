                ...
                <div class="widget-content widget-content-area">
                    <div class="row">
                        ...
                        <div class="col-12 col-xxl-4 col-xl-6 col-lg-8 col-md-8 col-sm-9">
                            <form method="post" autocomplete="off" action="{{ route("modules.update", $module->id) }}">
                                @csrf
                                <div class="form-group mb-4">
                                    <p>{{ __("label.form.modules") }} <code>*</code></p>
                                    <label for="t-Module" class="visually-hidden">{{ __("label.form.modules") }}</label>
                                    <input value="{{ old("txtModule", $module->name) }}" id="t-Module" type="text" name="txtModule" placeholder="{{ __("label.form.modules") }}" class="form-control" required autofocus tabindex="1"  />
                                    @error('txtModule')
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input value="{{ old("txtModuleKh", $module->name_kh) }}" id="t-ModuleKh" type="text" name="txtModuleKh" placeholder="{{ __("label.form.modules.kh") }}" class="form-control" required tabindex="2">
                                    @error('txtModuleKh')
                                    <span class="error text-danger pt-5">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    <input value="{{ old("txtModuleIcon", $module->icon) }}" id="t-ModuleIcon" type="text" name="txtModuleIcon" placeholder="{{ __("label.form.modules.icon") }}" class="form-control" tabindex="4">
                                </div>
                                <div class="form-group mb-4">
                                    <p>{{ __("label.form.modules.order") }} <code>*</code></p>
                                    <label for="t-ModuleOrder" class="visually-hidden">{{ __("label.form.modules.order") }}</label>
                                    <input value="{{ old("txtModuleOrder", $module->order) }}" id="t-ModuleOrder" type="text" name="txtModuleOrder" placeholder="{{ __("label.form.modules.order") }}" class="form-control" required tabindex="5">
                                </div>
