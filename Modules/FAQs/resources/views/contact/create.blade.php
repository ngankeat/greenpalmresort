...
@section("breadcrumbs")
    <nav class="breadcrumb-style-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route("faqs.contact.index") }}">{{ __("menus.sidebar.faqs.contact") }}</a></li>
                ...
                <div class="widget-content widget-content-area">
                    <div class="row">
                        ...
                        <div class="col-12 col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-9">
                            <form method="post" autocomplete="off" action="{{ route("faqs.contact.store") }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group mb-4">
                                    <p>{{ __("label.form.contact.title") }} <code>*</code></p>
                                    <label for="t-Title" class="visually-hidden">{{ __("label.form.contact.title") }}</label>
                                    <input id="t-Title" type="text" name="txtTitle" placeholder="{{ __("label.form.contact.title") }}" class="form-control" required autofocus tabindex="1"  />
                                    @error('txtContact')
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input id="t-Title_kh" type="text" name="txtTitleKh" placeholder="{{ __("label.form.contact.title.kh") }}" class="form-control" required autofocus tabindex="1"  />
                                    @error('txtContact')
                                    <span class="error text-danger pt-5">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    <textarea id="summernote" name="txtDescrioption" placeholder="{{ __("label.form.contact.descriptin") }}" class="form-control" tabindex="3"></textarea>
                                    @error('txtAnswer')
                                    <span class="error text-danger pt-5">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    <input id="t-Email" type="text" name="txtEmail" placeholder="{{ __("label.form.contact.email") }}" class="form-control" required autofocus tabindex="1"  />
                                    @error('txtContact')
                                    <span class="error text-danger pt-5">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    <input id="t-Phone" type="text" name="txtPhone" placeholder="{{ __("label.form.contact.phone") }}" class="form-control" required autofocus tabindex="1"  />
                                    @error('txtContact')
                                    <span class="error text-danger pt-5">{{ $message }}</span>
                                    @enderror
                                </div>
