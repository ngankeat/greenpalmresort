...
class ModulesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($module) {
                return view('setups::modules.action', ['module' => $module]);
            })
     ...
     */
    public function query(Modules $model, Request $request): QueryBuilder
    {
        $model = $model->newQuery();
        $model->withTrashed();
        $model->select(['modules.id', 'modules.icon', 'modules.name', 'modules.name_kh', 'modules.order', 'modules.deleted_at', 'is_border_bottom']);
        return $model;
    }
    ...
    public function getColumns(): array
    {
        ...
        return [
            ...
            Column::make('name_kh')->title(__('label.table.th.modules.kh')),
