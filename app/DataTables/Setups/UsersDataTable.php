...
class UsersDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($module) {
                return view('setups::users.action', ['module' => $module]);
            })
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('username')->title(__('label.table.th.username')),
            Column::make('email')->title(__('label.table.th.email')),
            Column::make('RKH')->title(__('label.table.th.permission'))->width(60)->width(150)->addClass('text-center'),
