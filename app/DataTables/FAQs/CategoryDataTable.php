...
class CategoryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($module) {
                return view('faqs::category.action', ['module' => $module]);
            })
     ...
     */
    public function query(FAQsCategories $model, Request $request): QueryBuilder
    {
        ...
        $model->withTrashed();
        $model->select(['f_a_qs_categories.id', 'f_a_qs_categories.name', 'f_a_qs_categories.sound', 'f_a_qs_categories.order', 'f_a_qs_categories.icon', 'f_a_qs_categories.deleted_at']);
        return $model;
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('sound')->title(__('label.table.th.sound'))->width(30)->addClass('text-center'),
            Column::make('name')->title(__('label.table.th.modules')),
