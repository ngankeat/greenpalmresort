...
class roomTypeDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($module) {
                return view('faqs::roomType.action', ['module' => $module]);
            })
    ...
    public function query(FAQsModels $model, Request $request): QueryBuilder
    {
        ...
        $model->select([
            'roomType.id',
            'roomType.properties_id',
            'roomType.amenities_id',
            'roomType.facilities_id',
            'roomType.description_short',
            'roomType.description_long',
            'roomType.room_name',
            'roomType.price',
            'roomType.promotion',
        ]);
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('room_name')->title(__('label.table.th.question')),
            Column::make('price')->title(__('label.table.th.order'))->addClass('text-center'),
